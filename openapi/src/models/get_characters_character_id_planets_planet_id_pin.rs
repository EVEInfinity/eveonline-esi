...
pub struct GetCharactersCharacterIdPlanetsPlanetIdPin {
    ...
    pub contents: Option<Vec<models::GetCharactersCharacterIdPlanetsPlanetIdContent>>,
    /// expiry_time string
    ...
    pub extractor_details: Option<Box<models::GetCharactersCharacterIdPlanetsPlanetIdExtractorDetails>>,
    #[serde(rename = "factory_details", skip_serializing_if = "Option::is_none")]
    pub factory_details: Option<Box<models::GetCharactersCharacterIdPlanetsPlanetIdFactoryDetails>>,
    /// install_time string
