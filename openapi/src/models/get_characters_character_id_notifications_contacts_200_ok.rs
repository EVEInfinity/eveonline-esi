...
impl GetCharactersCharacterIdNotificationsContacts200Ok {
    /// 200 ok object
    pub fn new(message: String, notification_id: i64, send_date: String, sender_character_id: i32, standing_level: f32) -> GetCharactersCharacterIdNotificationsContacts200Ok {
