...
impl GetCharactersCharacterIdContracts200Ok {
    /// 200 ok object
    pub fn new(acceptor_id: i32, assignee_id: i32, availability: Availability, contract_id: i32, date_expired: String, date_issued: String, for_corporation: bool, issuer_corporation_id: i32, issuer_id: i32, status: Status, r#type: Type) -> GetCharactersCharacterIdContracts200Ok {
