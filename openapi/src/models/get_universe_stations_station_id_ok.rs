...
pub struct GetUniverseStationsStationIdOk {
    ...
    pub position: Box<models::GetUniverseStationsStationIdPosition>,
    /// race_id integer
...
impl GetUniverseStationsStationIdOk {
    /// 200 ok object
    pub fn new(max_dockable_ship_volume: f32, name: String, office_rental_cost: f32, position: models::GetUniverseStationsStationIdPosition, reprocessing_efficiency: f32, reprocessing_stations_take: f32, services: Vec<Services>, station_id: i32, system_id: i32, type_id: i32) -> GetUniverseStationsStationIdOk {
