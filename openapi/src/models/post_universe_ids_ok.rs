...
pub struct PostUniverseIdsOk {
    ...
    pub agents: Option<Vec<models::PostUniverseIdsAgent>>,
    /// alliances array
    #[serde(rename = "alliances", skip_serializing_if = "Option::is_none")]
    pub alliances: Option<Vec<models::PostUniverseIdsAlliance>>,
    /// characters array
    #[serde(rename = "characters", skip_serializing_if = "Option::is_none")]
    pub characters: Option<Vec<models::PostUniverseIdsCharacter>>,
    /// constellations array
    #[serde(rename = "constellations", skip_serializing_if = "Option::is_none")]
    pub constellations: Option<Vec<models::PostUniverseIdsConstellation>>,
    /// corporations array
    #[serde(rename = "corporations", skip_serializing_if = "Option::is_none")]
    pub corporations: Option<Vec<models::PostUniverseIdsCorporation>>,
    /// factions array
    #[serde(rename = "factions", skip_serializing_if = "Option::is_none")]
    pub factions: Option<Vec<models::PostUniverseIdsFaction>>,
    /// inventory_types array
    #[serde(rename = "inventory_types", skip_serializing_if = "Option::is_none")]
    pub inventory_types: Option<Vec<models::PostUniverseIdsInventoryType>>,
    /// regions array
    #[serde(rename = "regions", skip_serializing_if = "Option::is_none")]
    pub regions: Option<Vec<models::PostUniverseIdsRegion>>,
    /// stations array
    #[serde(rename = "stations", skip_serializing_if = "Option::is_none")]
    pub stations: Option<Vec<models::PostUniverseIdsStation>>,
    /// systems array
    #[serde(rename = "systems", skip_serializing_if = "Option::is_none")]
    pub systems: Option<Vec<models::PostUniverseIdsSystem>>,
}
