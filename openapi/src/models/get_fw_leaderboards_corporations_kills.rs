...
pub struct GetFwLeaderboardsCorporationsKills {
    ...
    pub active_total: Vec<models::GetFwLeaderboardsCorporationsActiveTotalActiveTotal>,
    /// Top 10 ranking of corporations by kills in the past week
    #[serde(rename = "last_week")]
    pub last_week: Vec<models::GetFwLeaderboardsCorporationsLastWeekLastWeek>,
    /// Top 10 ranking of corporations by kills in the past day
    #[serde(rename = "yesterday")]
    pub yesterday: Vec<models::GetFwLeaderboardsCorporationsYesterdayYesterday>,
}
