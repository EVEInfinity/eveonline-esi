...
impl GetCharactersCharacterIdNotifications200Ok {
    /// 200 ok object
    pub fn new(notification_id: i64, sender_id: i32, sender_type: SenderType, timestamp: String, r#type: Type) -> GetCharactersCharacterIdNotifications200Ok {
...
pub enum Type {
    ...
    #[serde(rename = "CorporationGoalExpired")]
    CorporationGoalExpired,
    #[serde(rename = "CorporationGoalLimitReached")]
    CorporationGoalLimitReached,
    #[serde(rename = "CorporationGoalNameChange")]
    CorporationGoalNameChange,
    #[serde(rename = "CorporationLeft")]
    CorporationLeft,
    #[serde(rename = "CustomsMsg")]
    CustomsMsg,
    #[serde(rename = "DailyItemRewardAutoClaimed")]
    ...
    FacWarLpPayoutKill,
    #[serde(rename = "FreelanceProjectClosed")]
    FreelanceProjectClosed,
    #[serde(rename = "FreelanceProjectCompleted")]
    FreelanceProjectCompleted,
    #[serde(rename = "FreelanceProjectCreated")]
    FreelanceProjectCreated,
    #[serde(rename = "FreelanceProjectExpired")]
    FreelanceProjectExpired,
    #[serde(rename = "FreelanceProjectLimitReached")]
    FreelanceProjectLimitReached,
    #[serde(rename = "FreelanceProjectParticipantKicked")]
    ...
    #[serde(rename = "MercenaryDenAttacked")]
    MercenaryDenAttacked,
    #[serde(rename = "MercenaryDenNewMTO")]
    MercenaryDenNewMto,
    #[serde(rename = "MercenaryDenReinforced")]
    ...
    RetractsWar,
    #[serde(rename = "SPAutoRedeemed")]
    SpAutoRedeemed,
    #[serde(rename = "SeasonalChallengeCompleted")]
    SeasonalChallengeCompleted,
    #[serde(rename = "SkinSequencingCompleted")]
    SkinSequencingCompleted,
    #[serde(rename = "SkyhookDeployed")]
    SkyhookDeployed,
    #[serde(rename = "SkyhookDestroyed")]
    SkyhookDestroyed,
    #[serde(rename = "SkyhookLostShields")]
    SkyhookLostShields,
    #[serde(rename = "SkyhookOnline")]
    SkyhookOnline,
    #[serde(rename = "SkyhookUnderAttack")]
    SkyhookUnderAttack,
    ...
    #[serde(rename = "StructureLowReagentsAlert")]
    StructureLowReagentsAlert,
    #[serde(rename = "StructureNoReagentsAlert")]
