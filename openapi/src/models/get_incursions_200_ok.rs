...
impl GetIncursions200Ok {
    /// 200 ok object
    pub fn new(constellation_id: i32, faction_id: i32, has_boss: bool, infested_solar_systems: Vec<i32>, influence: f32, staging_solar_system_id: i32, state: State, r#type: String) -> GetIncursions200Ok {
        GetIncursions200Ok {
            constellation_id,
            faction_id,
            has_boss,
