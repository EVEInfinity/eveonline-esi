...
pub struct GetFwLeaderboardsCorporationsVictoryPoints {
    ...
    pub active_total: Vec<models::GetFwLeaderboardsCorporationsActiveTotalActiveTotal1>,
    /// Top 10 ranking of corporations by victory points in the past week
    #[serde(rename = "last_week")]
    pub last_week: Vec<models::GetFwLeaderboardsCorporationsLastWeekLastWeek1>,
    /// Top 10 ranking of corporations by victory points in the past day
    #[serde(rename = "yesterday")]
    pub yesterday: Vec<models::GetFwLeaderboardsCorporationsYesterdayYesterday1>,
}
