...
> models::GetCharactersCharacterIdAttributesOk get_characters_character_id_attributes(character_id, datasource, if_none_match, token)
...
> Vec<models::GetCharactersCharacterIdSkillqueue200Ok> get_characters_character_id_skillqueue(character_id, datasource, if_none_match, token)
...
> models::GetCharactersCharacterIdSkillsOk get_characters_character_id_skills(character_id, datasource, if_none_match, token)
