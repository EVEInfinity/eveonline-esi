...
> Vec<models::GetCharactersCharacterIdKillmailsRecent200Ok> get_characters_character_id_killmails_recent(character_id, datasource, if_none_match, page, token)
...
> Vec<models::GetCorporationsCorporationIdKillmailsRecent200Ok> get_corporations_corporation_id_killmails_recent(corporation_id, datasource, if_none_match, page, token)
...
> models::GetKillmailsKillmailIdKillmailHashOk get_killmails_killmail_id_killmail_hash(killmail_hash, killmail_id, datasource, if_none_match)
