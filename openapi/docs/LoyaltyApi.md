...
> Vec<models::GetCharactersCharacterIdLoyaltyPoints200Ok> get_characters_character_id_loyalty_points(character_id, datasource, if_none_match, token)
Get loyalty points
...
> Vec<models::GetLoyaltyStoresCorporationIdOffers200Ok> get_loyalty_stores_corporation_id_offers(corporation_id, datasource, if_none_match)
