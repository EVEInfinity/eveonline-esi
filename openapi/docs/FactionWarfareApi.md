...
> models::GetCharactersCharacterIdFwStatsOk get_characters_character_id_fw_stats(character_id, datasource, if_none_match, token)
...
> models::GetCorporationsCorporationIdFwStatsOk get_corporations_corporation_id_fw_stats(corporation_id, datasource, if_none_match, token)
...
> models::GetFwLeaderboardsOk get_fw_leaderboards(datasource, if_none_match)
...
> models::GetFwLeaderboardsCharactersOk get_fw_leaderboards_characters(datasource, if_none_match)
...
> models::GetFwLeaderboardsCorporationsOk get_fw_leaderboards_corporations(datasource, if_none_match)
...
> Vec<models::GetFwStats200Ok> get_fw_stats(datasource, if_none_match)
...
> Vec<models::GetFwSystems200Ok> get_fw_systems(datasource, if_none_match)
...
> Vec<models::GetFwWars200Ok> get_fw_wars(datasource, if_none_match)
